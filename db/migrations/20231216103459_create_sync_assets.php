...
class CreateSyncAssets extends AbstractCapsuleMigration
{
    ...
    public function up()
    {
        ...
        // populate table with content of inventory.assets table (skip deleted and archived items)
        ...
        . " WHERE inventory.assets.deleted_at is null AND NOT (inventory.assets.status_id = 3)");
