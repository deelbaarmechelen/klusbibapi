...
class AlignLendenginePayment extends AbstractCapsuleMigration
{
	...
	public function up()
	{
        ...
        Capsule::update('INSERT INTO payment (id, created_at, type, payment_date, amount, psp_code, note, contact_id, membership_id, loan_id, kb_payment_timestamp, kb_mode, kb_state, kb_order_id, kb_expiration_date) '
            . 'SELECT (payment_id *2) -1, created_at, \'PAYMENT\', DATE(payment_date), amount, order_id, IFNULL(comment,\'Payment received.\'), user_id, membership_id, loan_id, payment_date, mode, state, order_id, expiration_date FROM kb_payments WHERE state = \'SUCCESS\'');
        Capsule::update('INSERT INTO payment (id, created_at, type, payment_date, amount, psp_code, note, contact_id, membership_id, loan_id, kb_payment_timestamp, kb_mode, kb_state, kb_order_id, kb_expiration_date) '
            . 'SELECT (payment_id *2) -1, created_at, \'PAYMENT\', DATE(payment_date), 0, order_id, comment, user_id, membership_id, loan_id, payment_date, mode, state, order_id, expiration_date FROM kb_payments WHERE state IN (\'CANCELED\', \'FAILED\', \'EXPIRED\', \'REFUND\', \'CHARGEBACK\')');
        Capsule::update('INSERT INTO payment (id, created_at, type, payment_date, amount, psp_code, note, contact_id, membership_id, loan_id, kb_payment_timestamp, kb_mode, kb_state, kb_order_id, kb_expiration_date) '
            . 'SELECT (payment_id *2) -1, created_at, \'PAYMENT\', DATE(payment_date), amount, order_id, comment, user_id, membership_id, loan_id, payment_date, mode, state, order_id, expiration_date FROM kb_payments WHERE state IN (\'OPEN\', \'PENDING\')');
